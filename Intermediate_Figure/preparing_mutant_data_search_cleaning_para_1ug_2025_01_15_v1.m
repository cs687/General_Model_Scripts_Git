    ...
    for strain_now=1:length(strains); 
        ...
        for day_now=1:length(data_day);
            ...
            if MY_smooth_tresh_on==1;
                ...
                % thresh_after=mean(MY_smooth(:))+6*std(MY_smooth(:));
                ...
                % good_smooth=sum(MY_smooth>thresh)==0;
                ...
                len_now=len_now(:,good_smooth);
                wid_now=wid_now(:,good_smooth);
                MR_now=MR_now(:,good_smooth);
                gr_now=gr_now(:,good_smooth);
            end
